    ...
    <div>
      ...
      <div style={{
        ...
        {(() => {
          ...
          const hasMedals = medalTypes.some(t =>
            Object.values(stats).some(yearData =>
              Object.values(yearData).some(compData => (compData[t]?.length || 0) > 0)
            )
          )
          const displayTypes = hasMedals ? medalTypes : tierTypes
